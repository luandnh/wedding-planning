    ...
    <form on:submit|preventDefault={handleConfigSubmit} class="space-y-6">
      ...
      <div>
        ...
        <div class="space-y-4">
          <div>
            <label
              for="groom-name"
              class="block text-sm font-medium text-slate-700">Tên chú rể</label
            >
            <input
              type="text"
              id="groom-name"
          ...
          <div>
            <label
              for="bride-name"
              class="block text-sm font-medium text-slate-700">Tên cô dâu</label
            >
            <input
              type="text"
              id="bride-name"
          ...
          <div>
            <label for="venue" class="block text-sm font-medium text-slate-700"
      ...
      <div>
          ...
          {#each config.importantDates as dateItem, index (index)}
            <div class="flex items-center gap-2">
              <input
                ...
                class="flex-grow px-3 py-2 border border-slate-300 rounded-lg"
              />
              <input
                type="date"
        ...
        <button
          ...
          class="mt-2 text-sm text-pink-600 font-semibold hover:underline"
          >+ Thêm ngày</button
        >
      </div>
